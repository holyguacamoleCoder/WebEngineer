...
<script>
import { getCourseApplicationById } from '@/api/course/course-application.js'
import { examineACourse } from '@/api/course/course-examination.js'
...
export default {
  ...
  methods: {
      ...
      async openDialog() {
          ...
          const result = await getCourseApplicationById(this.courseApplicationId)
